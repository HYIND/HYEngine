...
void handleCharacterMove(Transform& trans, Controller& controller, Movement& movement)
{
...
{
	auto& world = getWorld();
	std::vector<Entity> entities = world.getEntitiesWith<Transform, Controller, Movement>();
