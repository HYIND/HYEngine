...
namespace OpenGLRenderConfig
{
	...
	constexpr glm::vec3 fogColor = glm::vec3(0.25, 0.3, 0.6);
	constexpr float fogHeight = -45.f;
	constexpr float fogDistanceFalloff = 0.02;
	constexpr float fogHeightFalloff = 0.01;
