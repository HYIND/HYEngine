...
BloomPass::BloomPass(const std::string& bloomVertexShaderPath, const std::string& bloomFragmentShaderPath, float SCR_WIDTH, float SCR_HEIGHT)
...
void BloomPass::init()
{
	...
	genernate(pingpongFBO1, pingpongColorBuffer1, SCR_WIDTH, SCR_HEIGHT);
	genernate(pingpongFBO2, pingpongColorBuffer2, SCR_WIDTH, SCR_HEIGHT);

	pingpongFBO[0] = pingpongFBO1;
	pingpongFBO[1] = pingpongFBO2;
	pingpongColorBuffers[0] = pingpongColorBuffer1;
	pingpongColorBuffers[1] = pingpongColorBuffer2;
