...
{
	return state.flags.autoExposureOn && state.framebuffer.width > 0 && state.framebuffer.height > 0;
}

void AutoExposurePass::Excute(const OpenGLRenderGraph::PassContext& ctx, RenderState& state)
{
