...
public:
	...
	void setTexture(const std::shared_ptr<TextureCube>& tex, const std::string& name, unsigned int slot);
	void setTexture(const std::unique_ptr<TextureCube>& tex, const std::string& name, unsigned int slot);
	void setTexture(const TextureCube& tex, const std::string& name, unsigned int slot);
