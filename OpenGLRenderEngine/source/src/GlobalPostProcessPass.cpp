...
GlobalPostProcessPass::GlobalPostProcessPass(const std::string& vertexShaderPath, const std::string& fragmentShaderPath, uint32_t SCR_WIDTH, uint32_t SCR_HEIGHT)
...
void GlobalPostProcessPass::OnResize(uint32_t newWidth, uint32_t newHeight)
{
